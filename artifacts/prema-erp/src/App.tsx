...
function Shell({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { label: 'Cartera', icon: CreditCard, activePrefix: '/app/cartera', children: [{ href: '/app/cartera', label: 'Cartera', icon: CreditCard }, { href: '/app/clientes', label: 'Clientes', icon: Users }] },
    { label: 'Reportes', icon: BarChart3, activePrefix: '/app/reportes', children: [{ href: '/app/reportes/ventas', label: 'Reporte de ventas', icon: ReceiptText }, { href: '/app/reportes/bajas', label: 'Bajas de inventario', icon: Box }] },
  ];
