...
import {
   ArrowRight, BarChart3, Box, Camera, Check, ChevronDown, CircleDollarSign, ClipboardList,
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async () => {
      try {
        ...
        const res = await fetch(`/api/products/${product!.id}/image`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ image: base64 }) });
